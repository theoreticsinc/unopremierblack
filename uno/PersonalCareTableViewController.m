...
- (void)viewDidLoad
{
    ...
    productsIcons = [NSArray arrayWithObjects:@"toothgel.jpg", @"icarenapkin.jpg",  nil];
    productsImages = [NSArray arrayWithObjects:@"prod_toothgel.jpg", @"prod_icarenapkin.jpg",  nil];
