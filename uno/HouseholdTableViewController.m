...
{
    [super viewDidLoad];
    products = [NSArray arrayWithObjects:@"Dishwashing Liquid", @"Laundry Granules", @"Scare Away", nil];
    productsImages = [NSArray arrayWithObjects:@"dishwashing.png", @"organicLaundry.png",@"scareAway.png",  nil];
